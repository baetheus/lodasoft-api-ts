...
export declare type LELodasoftCommonModelsLeadsLeadListViewModel = {
...
export declare const LELodasoftCommonModelsLeadsLeadListViewModelIO: import("io-ts").TypeC<{
    leadListId: import("io-ts-types").OptionFromNullableC<import("io-ts").NumberC>;
    ...
    leadIds: import("io-ts-types").OptionFromNullableC<import("io-ts").ArrayC<import("io-ts").NumberC>>;
