...
export declare type LELodasoftApiModelsMortgageProcessDuViewModel = {
...
export declare const LELodasoftApiModelsMortgageProcessDuViewModelIO: import("io-ts").TypeC<{
    ...
    linkBorrowers: import("io-ts-types").OptionFromNullableC<import("io-ts").RecordC<import("io-ts").StringC, import("io-ts").NumberC>>;
    loanCharacteristics: import("io-ts-types").OptionFromNullableC<import("io-ts").ArrayC<import("io-ts").NumberC>>;
    ...
    alignmentGroupId: import("io-ts-types").OptionFromNullableC<import("io-ts").StringC>;
}>;
