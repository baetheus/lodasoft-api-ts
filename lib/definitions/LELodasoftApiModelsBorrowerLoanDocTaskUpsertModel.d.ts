...
export declare type LELodasoftApiModelsBorrowerLoanDocTaskUpsertModel = {
...
export declare const LELodasoftApiModelsBorrowerLoanDocTaskUpsertModelIO: import("io-ts").TypeC<{
    loanDocTask: import("io-ts-types").OptionFromNullableC<import("io-ts").TypeC<{
    ...
    multipleBorrower: import("io-ts-types").OptionFromNullableC<import("io-ts").ArrayC<import("io-ts").NumberC>>;
    numFiles: import("io-ts-types").OptionFromNullableC<import("io-ts").NumberC>;
    expirationDate: import("io-ts-types").OptionFromNullableC<import("io-ts-types").DateFromISOStringC>;
}>;
