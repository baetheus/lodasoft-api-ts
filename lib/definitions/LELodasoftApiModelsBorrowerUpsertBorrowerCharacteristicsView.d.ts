...
export declare type LELodasoftApiModelsBorrowerUpsertBorrowerCharacteristicsView = {
...
export declare const LELodasoftApiModelsBorrowerUpsertBorrowerCharacteristicsViewIO: import("io-ts").TypeC<{
    borrowerCharacteristics: import("io-ts-types").OptionFromNullableC<import("io-ts").ArrayC<import("io-ts").TypeC<{
