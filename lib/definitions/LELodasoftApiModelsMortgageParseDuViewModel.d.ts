...
export declare type LELodasoftApiModelsMortgageParseDuViewModel = {
    mortgageViewModel: Option<LELodasoftCommonModelsMortgageMortgageViewModel>;
    suggestedBorrowers: Option<{
        [key: string]: Array<LELodasoftDataAccessModelsAdminBorrowerBorrowerDto>;
    }>;
...
export declare const LELodasoftApiModelsMortgageParseDuViewModelIO: import("io-ts").TypeC<{
    mortgageViewModel: import("io-ts-types").OptionFromNullableC<import("io-ts").TypeC<{
    ...
    suggestedBorrowers: import("io-ts-types").OptionFromNullableC<import("io-ts").RecordC<import("io-ts").StringC, import("io-ts").ArrayC<import("io-ts").TypeC<{
        borrowerId: import("io-ts-types").OptionFromNullableC<import("io-ts").NumberC>;
        companyId: import("io-ts-types").OptionFromNullableC<import("io-ts").NumberC>;
        creditScore: import("io-ts-types").OptionFromNullableC<import("io-ts").NumberC>;
        firstName: import("io-ts-types").OptionFromNullableC<import("io-ts").StringC>;
