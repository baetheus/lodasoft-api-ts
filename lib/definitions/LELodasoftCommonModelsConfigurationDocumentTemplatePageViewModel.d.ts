...
export declare type LELodasoftCommonModelsConfigurationDocumentTemplatePageViewModel = {
...
export declare const LELodasoftCommonModelsConfigurationDocumentTemplatePageViewModelIO: import("io-ts").TypeC<{
