...
export declare type LELodasoftCommonModelsConfigurationConfigurationViewModel = {
    id: Option<number>;
    key: Option<string>;
    value: Option<number>;
...
export declare const LELodasoftCommonModelsConfigurationConfigurationViewModelIO: import("io-ts").TypeC<{
