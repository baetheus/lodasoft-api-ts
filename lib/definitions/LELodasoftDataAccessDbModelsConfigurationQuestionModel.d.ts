...
export declare const LELodasoftDataAccessDbModelsConfigurationQuestionModelIO: import("io-ts").TypeC<{
    ...
    questionType: import("io-ts-types").OptionFromNullableC<import("io-ts").KeyofC<{
        Immediately: null;
        OnLoanStatus: null;
        Private: null;
        Group: null;
