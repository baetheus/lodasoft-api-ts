...
exports.LELodasoftDataAccessDbModelsAdminApplicationModelIO = io_ts_1.type({
    ...
    thirdPartyCredentialProviderId: io_ts_types_1.createOptionFromNullable(io_ts_1.number),
    losVendor: io_ts_types_1.createOptionFromNullable(io_ts_1.keyof({ Encompass: null, LendingQb: null })),
...
//# sourceMappingURL=LELodasoftDataAccessDbModelsAdminApplicationModel.js.map