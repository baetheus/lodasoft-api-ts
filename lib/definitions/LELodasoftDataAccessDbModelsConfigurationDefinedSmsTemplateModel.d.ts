...
export declare type LELodasoftDataAccessDbModelsConfigurationDefinedSmsTemplateModel = {
    id: Option<number>;
...
export declare const LELodasoftDataAccessDbModelsConfigurationDefinedSmsTemplateModelIO: import("io-ts").TypeC<{
