...
exports.LELodasoftCommonModelsMortgageEmailViewModelIO = io_ts_1.type({
    emailId: io_ts_types_1.createOptionFromNullable(io_ts_1.number),
    ...
    typeOfEmail: io_ts_types_1.createOptionFromNullable(io_ts_1.keyof({ PrimaryEmail: null, AdditionalEmail: null })),
...
//# sourceMappingURL=LELodasoftCommonModelsMortgageEmailViewModel.js.map