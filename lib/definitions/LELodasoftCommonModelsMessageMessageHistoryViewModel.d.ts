...
export declare type LELodasoftCommonModelsMessageMessageHistoryViewModel = {
...
export declare const LELodasoftCommonModelsMessageMessageHistoryViewModelIO: import("io-ts").TypeC<{
    extendedDetail: import("io-ts-types").OptionFromNullableC<import("io-ts").StringC>;
