...
export const LELodasoftCommonModelsSharedApplicationViewIO = type({
	...
	onlineAppInProgress: createOptionFromNullable(boolean),
	forceFinishOnlineApp: createOptionFromNullable(boolean),
	myDetails: createOptionFromNullable(LELodasoftCommonModelsSharedBorrowerViewIO),
	otherBorrowersOnLoan: createOptionFromNullable(array(LELodasoftCommonModelsSharedBorrowerViewIO)),
});
